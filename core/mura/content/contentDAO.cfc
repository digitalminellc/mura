...
<cffunction name="create" output="false">
      ...
      VALUES (
		...
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getMobileExclude()#">,
		...
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getMajorVersion()#">,
		<cfqueryparam cfsqltype="cf_sql_numeric" value="#arguments.contentBean.getMinorVersion()#">,
